// Operações de Set: Escreva um programa Java que usa um Set para armazenar uma coleção de elementos únicos.
// Implemente operações como adicionar elementos, remover elementos, verificar se um elemento existe e iterar pelo Set usando um iterador.

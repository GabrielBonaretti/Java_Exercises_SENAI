...
public class Exercise7 {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                showListAscending(list);
            } else if (choice == 5) {
                showListDescending(list);
            } else {
    ...
    static void menu(){
        ...
        System.out.println("[4] Show list in ascending order");
        System.out.println("[5] show list in descending order");
    }
    ...
    static void showListAscending(ArrayList<String> list){
        System.out.println("---------------------------------");
    ...
    static void showListDescending(ArrayList<String> list){
        System.out.println("---------------------------------");
        System.out.println("List:");
